    ...
    <div class="col-12 col-lg-6 col-xl-4 border-top-wide border-primary d-flex flex-column justify-content-center">
      <div class="container container-tight my-5 px-lg-5">
        ...
        <div class="form-footer">
          <button @click="signIn" class="btn btn-primary w-100">Sign in</button>
        </div>
        <div class="text-center text-secondary mt-3">Hesabın yok mu? <a href="#" tabindex="-1">Kayıt Ol</a></div>
      </div>
    </div>
    <div class="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
      <div class="bg-cover h-100 min-vh-100" style="background-image: url(./img/photos/login-1.jpg)"></div>
    </div>
  </div>
</template>
<script>
